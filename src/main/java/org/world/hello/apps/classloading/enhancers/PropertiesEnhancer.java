package org.world.hello.apps.classloading.enhancers;
...
public class PropertiesEnhancer extends Enhancer {
                        ...
                        if (isProperty(fieldAccess.getField())) {
                            ...
                            if (propertyName == null || !propertyName.equals(fieldAccess.getFieldName())) {
                                ...
                                if (fieldAccess.isReader()) {
                                    ...
                                    fieldAccess.replace("$_ = ($r)org.world.hello.apps.classloading.enhancers.PropertiesEnhancer.FieldAccessor.invokeReadProperty($0, \"" + fieldAccess.getFieldName() + "\", \"" + fieldAccess.getClassName() + "\", \"" + invocationPoint + "\");");

                                } else if (fieldAccess.isWriter()) {

                                    // Réécris l'accés en ecriture à la property
                                    fieldAccess.replace("org.world.hello.apps.classloading.enhancers.PropertiesEnhancer.FieldAccessor.invokeWriteProperty($0, \"" + fieldAccess.getFieldName() + "\", " + fieldAccess.getField().getType().getName() + ".class, $1, \"" + fieldAccess.getClassName() + "\", \"" + invocationPoint + "\");");
    ...
    public static class FieldAccessor {
        ...
        public static Object invokeReadProperty(Object o, String property, String targetType, String invocationPoint) throws Throwable {
            ...
            if (!o.getClass().getClassLoader().equals(DynamicRuntime.classloader)) {
