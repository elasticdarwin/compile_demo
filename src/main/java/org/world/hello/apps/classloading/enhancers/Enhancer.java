...
public abstract class Enhancer {
    ...
    public static class ApplicationClassesClasspath implements ClassPath {
        ...
        public InputStream openClassfile(String className) throws NotFoundException {
            return new ByteArrayInputStream(DynamicRuntime.classes.getApplicationClass(className).enhancedByteCode);
        }

        public URL find(String className) {
            if (DynamicRuntime.classes.getApplicationClass(className) != null) {
